...
// const type = "text/plain base64:d8fnajfsdlksldfajjfkdjsdfajaio";
// let isImage = type.includes("image");
// console.log(isImage);

// replace(old, new), replaceAll(old, new)
// old를 찾은 뒤 new로 교체하고 싶을 때 사용한다.
// replace()는 중복된 old값이 있어도 첫번째 값만 교체되고,
// replaceAll()은 old값에 전달한 값을 전체에서 찾은뒤 모두 교체한다.
...
// const i = "ABCD".indexOf("A");
// console.log(i);
// const a = "ABCD".indexOf("A");
// console.log(a);
